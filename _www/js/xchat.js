/**
 * Generated with nimble-ide v5.1 on 04/15/2025 05:52 pm.
...
$heap.xchat.Code = {
	...
	Services: function(in_msg) {
		...
		**/
		switch (in_msg.msg) {
			case 'ping':
				alert("xchat received ping sent from: " + in_msg.from);
				break;
...
$k.wrapallfunctions($heap.xchat.Code);
...
$heap.xchat['applanding'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'applanding'; }
			
			$k.instance.newform(pos.form, App.Dialog['applanding']);
			instName = $heap.xchat[pos.form].Load(pos);
		}
		catch (err) {
			if ($k.errhandler) {
			...
			if (show) { $heap.xchat[pos.form].Show(pos); }
		...
		try {
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('applanding', itm[0], itm[1], $nim.fn.findEvent('xchat', 'applanding', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					$f.setprop('applanding','', props);
					styles = [{"name":"body.background-color","value":"white"},{"name":"body.box-sizing","value":"border-box"},{"name":"body.color","value":"#eeeeee"},{"name":"body.margin","value":"0px 0px 0px 0px"},{"name":"body.overflow-y","value":"auto"},{"name":"body.padding","value":"20px 20px 20px 20px"},{"name":"body.text-align","value":""},{"name":"body.vertical-align","value":""}];
					$f.setstyle('applanding','', styles);
					...
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('applanding','','forceshow').toLowerCase() == 'true') $heap.xchat['applanding'].Show(pos);
					return;
				});
...
$k.wrapallfunctions($heap.xchat['applanding'].Code, 'applanding');
...
$heap.xchat['loginforgot'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginforgot'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			$f.add('loginforgot','email','textbox','','0','0','273','42');
				...
				styles = [{"name":"color","value":"#ffffff"},{"name":"background-color","value":"transparent"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"verdana, geneva, sans-serif"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"block"},{"name":"outline","value":"none"},{"name":"padding","value":"10px"},{"name":"visibility","value":"visible"},{"name":"border-radius","value":"11px"},{"name":"border-style","value":"solid"},{"name":"border-width","value":"0px"},{"name":"box-sizing","value":"border-box"},{"name":"font-size","value":"14px"},{"name":"pointer-events","value":"inherit"},{"name":"vertical-align","value":"top"},{"name":"div.background-color","value":"transparent"},{"name":"div.border-radius","value":"11px"},{"name":"div.border","value":"1px solid #ddd"},{"name":"div.display","value":"block"},{"name":"div.margin","value":"8px 8px 40px 0px"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"relative"}];
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginforgot', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginforgot', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					props = [{"name":"body.version","value":"v5.0"}];
					$f.setprop('loginforgot','', props);
					styles = [{"name":"body.background-color","value":"white"},{"name":"body.box-sizing","value":"border-box"},{"name":"body.color","value":"#eeeeee"},{"name":"body.margin","value":"0px 0px 0px 0px"},{"name":"body.overflow-y","value":"auto"},{"name":"body.padding","value":"50px 50px 50px 50px"},{"name":"body.text-align","value":""},{"name":"body.vertical-align","value":""}];
					$f.setstyle('loginforgot','', styles);
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginforgot','','forceshow').toLowerCase() == 'true') $heap.xchat['loginforgot'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginforgot'].Code, 'loginforgot');
...
$heap.xchat['loginmain'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginmain'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			$f.add('loginmain','lbspace1','label-right','','0','0','372','40');
				...
				styles = [{"name":"color","value":"#add8e6"},{"name":"background-color","value":"transparent"},{"name":"font-style","value":"italic"},{"name":"font-family","value":"verdana, geneva, sans-serif"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"block"},{"name":"display","value":"table"},{"name":"height","value":"calc(50% - 220px)"},{"name":"padding","value":"0px 0px"},{"name":"visibility","value":"visible"},{"name":"border-style","value":"solid"},{"name":"border-width","value":"0px"},{"name":"font-size","value":"12px"},{"name":"pointer-events","value":"inherit"},{"name":"text-align","value":"left"},{"name":"caption.display","value":"table-cell"},{"name":"caption.left","value":"0px"},{"name":"caption.position","value":"relative"},{"name":"caption.text-align","value":"center"},{"name":"caption.vertical-align","value":"middle"},{"name":"caption.width","value":"auto"},{"name":"div.display","value":"block"},{"name":"div.margin","value":"0px 0px 0px 0px"},{"name":"div.padding","value":"0px 0px 0px 0px"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"relative"}];
			...
			$f.add('loginmain','lbdiv','label','','0','0','380','13');
			...
			$f.add('loginmain','username','textbox','','0','0','372','42');
				...
				styles = [{"name":"color","value":"#ffffff"},{"name":"border-width","value":"0px"},{"name":"background-color","value":"transparent"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"verdana, geneva, sans-serif"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"block"},{"name":"border","value":"0px solid #ddd"},{"name":"outline","value":"none"},{"name":"padding","value":"10px"},{"name":"visibility","value":"visible"},{"name":"border-radius","value":"11px"},{"name":"box-sizing","value":"border-box"},{"name":"font-size","value":"14px"},{"name":"pointer-events","value":"inherit"},{"name":"vertical-align","value":"top"},{"name":"div.background-color","value":"transparent"},{"name":"div.border-radius","value":"11px"},{"name":"div.border","value":"1px solid #ddd"},{"name":"div.display","value":"block"},{"name":"div.margin","value":"6px 8px 20px 0px"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"relative"}];
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginmain', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginmain', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					props = [{"name":"body.version","value":"v5.0"}];
					$f.setprop('loginmain','', props);
					styles = [{"name":"body.background-color","value":"white"},{"name":"body.box-sizing","value":"border-box"},{"name":"body.color","value":"#eeeeee"},{"name":"body.margin","value":"0px 0px 0px 0px"},{"name":"body.overflow-y","value":"auto"},{"name":"body.padding","value":"40px 50px 50px 50px"},{"name":"body.text-align","value":"left"},{"name":"body.vertical-align","value":""}];
					$f.setstyle('loginmain','', styles);
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginmain','','forceshow').toLowerCase() == 'true') $heap.xchat['loginmain'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginmain'].Code, 'loginmain');
...
$heap.xchat['loginmsg'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginmsg'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginmsg', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginmsg', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginmsg','','forceshow').toLowerCase() == 'true') $heap.xchat['loginmsg'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginmsg'].Code, 'loginmsg');
...
$heap.xchat['loginprofile'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginprofile'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			$f.add('loginprofile','login','textbox','','0','0','362','42');
				...
				styles = [{"name":"color","value":"#ffffff"},{"name":"border-width","value":"0px"},{"name":"background-color","value":"transparent"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"verdana, geneva, sans-serif"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"inline-block"},{"name":"border","value":"0px solid #ddd"},{"name":"outline","value":"none"},{"name":"padding","value":"10px"},{"name":"visibility","value":"visible"},{"name":"border-radius","value":"11px"},{"name":"box-sizing","value":"border-box"},{"name":"font-size","value":"14px"},{"name":"pointer-events","value":"inherit"},{"name":"vertical-align","value":"top"},{"name":"div.background-color","value":"transparent"},{"name":"div.border-radius","value":"11px"},{"name":"div.border","value":"1px solid #ddd"},{"name":"div.display","value":"inline-block"},{"name":"div.margin","value":"3px 8px 10px 0px"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"relative"},{"name":"div.width","value":"92%"}];
			...
			$f.add('loginprofile','email','textbox','','0','0','384','42');
				...
				styles = [{"name":"color","value":"#ffffff"},{"name":"background-color","value":"#eaeaea"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"verdana, geneva, sans-serif"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"inline-block"},{"name":"outline","value":"none"},{"name":"padding","value":"10px"},{"name":"visibility","value":"visible"},{"name":"border-radius","value":"11px"},{"name":"border-style","value":"solid"},{"name":"border-width","value":"0px"},{"name":"box-sizing","value":"border-box"},{"name":"font-size","value":"14px"},{"name":"vertical-align","value":"top"},{"name":"div.background-color","value":"transparent"},{"name":"div.border-color","value":"#bbb"},{"name":"div.border-radius","value":"11px"},{"name":"div.border","value":"1px solid #ddd"},{"name":"div.display","value":"inline-block"},{"name":"div.margin","value":"3px 8px 10px 0px"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"relative"},{"name":"div.width","value":"92%"}];
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginprofile', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginprofile', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					props = [{"name":"body.version","value":"v5.0"}];
					$f.setprop('loginprofile','', props);
					styles = [{"name":"body.background-color","value":"var(--color50)"},{"name":"body.box-sizing","value":"border-box"},{"name":"body.color","value":"#eeeeee"},{"name":"body.margin","value":"0px 0px 0px 0px"},{"name":"body.overflow-y","value":"auto"},{"name":"body.padding","value":"35px 20px 30px 50px"},{"name":"body.text-align","value":"left"},{"name":"body.vertical-align","value":""}];
					$f.setstyle('loginprofile','', styles);
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginprofile','','forceshow').toLowerCase() == 'true') $heap.xchat['loginprofile'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginprofile'].Code, 'loginprofile');
...
$heap.xchat['loginregister'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginregister'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginregister', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginregister', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					props = [{"name":"body.version","value":"v5.0"}];
					$f.setprop('loginregister','', props);
					styles = [{"name":"body.background-color","value":"white"},{"name":"body.box-sizing","value":"border-box"},{"name":"body.color","value":"#eeeeee"},{"name":"body.margin","value":"0px 0px 0px 0px"},{"name":"body.overflow-y","value":"auto"},{"name":"body.padding","value":"30px 50px 50px 50px"},{"name":"body.text-align","value":""},{"name":"body.vertical-align","value":""}];
					$f.setstyle('loginregister','', styles);
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginregister','','forceshow').toLowerCase() == 'true') $heap.xchat['loginregister'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginregister'].Code, 'loginregister');
...
$heap.xchat['loginsplash'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginsplash'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			$f.add('loginsplash','slogan','label-right','','20','639','419','21');
			...
			$f.add('loginsplash','image','imagex',options,'-4','157','468','203');
			...
			$f.add('loginsplash','bar','label','','-5','362','467','10');
				...
				styles = [{"name":"color","value":"#000000"},{"name":"border-width","value":"0px"},{"name":"background-color","value":"#113366"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"inherit"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"absolute"},{"name":"border","value":"0px solid #bbb"},{"name":"display","value":"table"},{"name":"padding","value":"0px 0px"},{"name":"visibility","value":"visible"},{"name":"font-size","value":"14px"},{"name":"text-align","value":"left"},{"name":"vertical-align","value":"middle"},{"name":"caption.display","value":"table-cell"},{"name":"caption.position","value":"relative"},{"name":"caption.vertical-align","value":"middle"},{"name":"caption.width","value":"auto"},{"name":"div.display","value":"inline-block"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"absolute"}];
				$f.setstyle('loginsplash','bar', styles);
			$f.add('loginsplash','bar1','label','','-4','374','467','8');
				props = [{"name":"disabled","value":false},{"name":"form","value":"loginsplash"},{"name":"dock","value":"FFFF"},{"name":"title","value":""},{"name":"caption","value":""},{"name":"json","value":"{}"},{"name":"extend","value":"<LB>'react':''<RB>"},{"name":"bind","value":"false"},{"name":"donottheme","value":"false"},{"name":"dragable","value":"false"},{"name":"scaletype","value":"false"},{"name":"sizeable","value":"false"},{"name":"theme","value":"nimble-label"},{"name":"watch","value":"false"},{"name":"xdragrange","value":"-1; -1"},{"name":"ydragrange","value":"-1; -1"},{"name":"scale-cpl","value":"25"}];
				$f.setprop('loginsplash','bar1', props);
				styles = [{"name":"color","value":"#000000"},{"name":"border-width","value":"0px"},{"name":"background-color","value":"#113366"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"inherit"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"absolute"},{"name":"border","value":"0px solid #bbb"},{"name":"display","value":"table"},{"name":"padding","value":"0px 0px"},{"name":"visibility","value":"visible"},{"name":"font-size","value":"14px"},{"name":"text-align","value":"left"},{"name":"vertical-align","value":"middle"},{"name":"caption.display","value":"table-cell"},{"name":"caption.position","value":"relative"},{"name":"caption.vertical-align","value":"middle"},{"name":"caption.width","value":"auto"},{"name":"div.display","value":"inline-block"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"absolute"}];
				$f.setstyle('loginsplash','bar1', styles);
			$f.add('loginsplash','bar2','label','','-5','383','467','4');
				props = [{"name":"disabled","value":false},{"name":"form","value":"loginsplash"},{"name":"dock","value":"FFFF"},{"name":"title","value":""},{"name":"caption","value":""},{"name":"json","value":"{}"},{"name":"extend","value":"<LB>'react':''<RB>"},{"name":"bind","value":"false"},{"name":"donottheme","value":"false"},{"name":"dragable","value":"false"},{"name":"scaletype","value":"false"},{"name":"sizeable","value":"false"},{"name":"theme","value":"nimble-label"},{"name":"watch","value":"false"},{"name":"xdragrange","value":"-1; -1"},{"name":"ydragrange","value":"-1; -1"},{"name":"scale-cpl","value":"25"}];
				$f.setprop('loginsplash','bar2', props);
				styles = [{"name":"color","value":"#000000"},{"name":"border-width","value":"0px"},{"name":"background-color","value":"#113366"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"inherit"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"absolute"},{"name":"border","value":"0px solid #bbb"},{"name":"display","value":"table"},{"name":"padding","value":"0px 0px"},{"name":"visibility","value":"visible"},{"name":"font-size","value":"14px"},{"name":"text-align","value":"left"},{"name":"vertical-align","value":"middle"},{"name":"caption.display","value":"table-cell"},{"name":"caption.position","value":"relative"},{"name":"caption.vertical-align","value":"middle"},{"name":"caption.width","value":"auto"},{"name":"div.display","value":"inline-block"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"absolute"}];
				$f.setstyle('loginsplash','bar2', styles);
			$f.add('loginsplash','bar3','label','','-5','389','467','2');
				props = [{"name":"disabled","value":false},{"name":"form","value":"loginsplash"},{"name":"dock","value":"FFFF"},{"name":"title","value":""},{"name":"caption","value":""},{"name":"json","value":"{}"},{"name":"extend","value":"<LB>'react':''<RB>"},{"name":"bind","value":"false"},{"name":"donottheme","value":"false"},{"name":"dragable","value":"false"},{"name":"scaletype","value":"false"},{"name":"sizeable","value":"false"},{"name":"theme","value":"nimble-label"},{"name":"watch","value":"false"},{"name":"xdragrange","value":"-1; -1"},{"name":"ydragrange","value":"-1; -1"},{"name":"scale-cpl","value":"25"}];
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginsplash', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginsplash', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					props = [{"name":"body.version","value":"v5.0"}];
					$f.setprop('loginsplash','', props);
					styles = [{"name":"body.background-color","value":"white"},{"name":"body.box-sizing","value":"border-box"},{"name":"body.color","value":"#eeeeee"},{"name":"body.margin","value":"0px 0px 0px 0px"},{"name":"body.overflow-y","value":"hidden"},{"name":"body.padding","value":"20px 20px 20px 20px"},{"name":"body.text-align","value":"center"},{"name":"body.vertical-align","value":""}];
					$f.setstyle('loginsplash','', styles);
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginsplash','','forceshow').toLowerCase() == 'true') $heap.xchat['loginsplash'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginsplash'].Code, 'loginsplash');
...
$heap.xchat['loginreset'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginreset'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginreset', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginreset', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					props = [{"name":"body.version","value":"v5.0"}];
					$f.setprop('loginreset','', props);
					styles = [{"name":"body.background-color","value":"white"},{"name":"body.box-sizing","value":"border-box"},{"name":"body.color","value":"#eeeeee"},{"name":"body.margin","value":"0px 0px 0px 0px"},{"name":"body.overflow-y","value":"auto"},{"name":"body.padding","value":"5px 50px 40px 50px"},{"name":"body.text-align","value":""},{"name":"body.vertical-align","value":""}];
					$f.setstyle('loginreset','', styles);
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginreset','','forceshow').toLowerCase() == 'true') $heap.xchat['loginreset'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginreset'].Code, 'loginreset');
...
$heap.xchat['loginconfirm'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginconfirm'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			$f.add('loginconfirm','frame','div','','0','0','380','107');
				...
				styles = [{"name":"left","value":""},{"name":"top","value":""},{"name":"width","value":""},{"name":"color","value":"#000000"},{"name":"border-spacing","value":"1px"},{"name":"border-width","value":"0px"},{"name":"background-color","value":"#ffffff"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"inherit"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"block"},{"name":"border","value":"none"},{"name":"display","value":"block"},{"name":"height","value":"auto"},{"name":"margin","value":"0px 0px 0px 0px"},{"name":"overflow","value":"visible"},{"name":"padding","value":"20px 20px 20px 20px"},{"name":"position","value":"relative"},{"name":"visibility","value":"visible"},{"name":"width","value":"auto"},{"name":"border-radius","value":"7px"},{"name":"box-shadow","value":"rgba(20,20,20,.85) 8px 8px 8px 0px"},{"name":"box-sizing","value":"border-box"},{"name":"font-size","value":"14px"},{"name":"pointer-events","value":"inherit"},{"name":"text-align","value":"left"},{"name":"vertical-align","value":"middle"}];
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginconfirm', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginconfirm', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginconfirm','','forceshow').toLowerCase() == 'true') $heap.xchat['loginconfirm'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginconfirm'].Code, 'loginconfirm');
...
$heap.xchat['loginprompt'] = {
	...
	New: function(pos, show) {
		...
		try {
			...
			if (!$heap.xchat[pos.form]) { pos.form = 'loginprompt'; }
    ...
    Load: function(pos) {
		...
		try {
			...
			$f.add('loginprompt','frame','div','','0','0','380','139');
				...
				styles = [{"name":"left","value":""},{"name":"top","value":""},{"name":"width","value":""},{"name":"color","value":"var(--color50)"},{"name":"border-spacing","value":"1px"},{"name":"border-width","value":"0px"},{"name":"background-color","value":"var(--color50)"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"inherit"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"block"},{"name":"border","value":"none"},{"name":"display","value":"block"},{"name":"height","value":"auto"},{"name":"margin","value":"0px 0px 0px 0px"},{"name":"overflow","value":"visible"},{"name":"padding","value":"20px 20px 20px 20px"},{"name":"position","value":"relative"},{"name":"visibility","value":"visible"},{"name":"width","value":"auto"},{"name":"border-radius","value":"7px"},{"name":"box-shadow","value":"rgba(20,20,20,.85) 8px 8px 8px 0px"},{"name":"box-sizing","value":"border-box"},{"name":"font-size","value":"14px"},{"name":"pointer-events","value":"inherit"},{"name":"text-align","value":"left"},{"name":"vertical-align","value":"middle"}];
				$f.setstyle('loginprompt','frame', styles);
			$f.add($f.getinstname('loginprompt','frame'),'msgtitle','label','','0','0','105','69');
				props = [{"name":"disabled","value":false},{"name":"form","value":"loginprompt"},{"name":"dock","value":"FFFF"},{"name":"title","value":""},{"name":"caption","value":"Password"},{"name":"json","value":"{}"},{"name":"extend","value":"<LB>'react':'<LF>'<RB>"},{"name":"bind","value":"false"},{"name":"donottheme","value":"false"},{"name":"dragable","value":"false"},{"name":"scaletype","value":"false"},{"name":"sizeable","value":"false"},{"name":"theme","value":"nimble-label"},{"name":"watch","value":"false"},{"name":"xdragrange","value":"-1; -1"},{"name":"ydragrange","value":"-1; -1"},{"name":"lock-pos","value":"!!!!"},{"name":"lock-width","value":"!!!!"},{"name":"scale-cpl","value":"25"}];
			...
			$f.add($f.getinstname('loginprompt','frame'),'input','textbox','','0','0','380','46');
				props = [{"name":"disabled","value":false},{"name":"form","value":"loginprompt"},{"name":"dock","value":"FFFF"},{"name":"title","value":""},{"name":"caption","value":""},{"name":"json","value":"{}"},{"name":"extend","value":"<LB>'react':'<LF>'<RB>"},{"name":"bind","value":"true"},{"name":"donottheme","value":"false"},{"name":"dragable","value":"false"},{"name":"placeholder","value":"Room password"},{"name":"sizeable","value":"false"},{"name":"theme","value":"nimble-textbox"},{"name":"watch","value":"false"},{"name":"xdragrange","value":"-1; -1"},{"name":"ydragrange","value":"-1; -1"},{"name":"db-key","value":"false"},{"name":"db-name","value":"input"},{"name":"db-type","value":"text"},{"name":"lock-pos","value":"!!!!"},{"name":"lock-width","value":"!!!!"}];
				$f.setprop('loginprompt','input', props);
				styles = [{"name":"color","value":"#ffffff"},{"name":"border-width","value":"0px"},{"name":"background-color","value":"transparent"},{"name":"font-style","value":"normal"},{"name":"font-family","value":"inherit"},{"name":"font-weight","value":"normal"},{"name":"displaymode","value":"block"},{"name":"border","value":"0px solid #ddd"},{"name":"outline","value":"none"},{"name":"padding","value":"10px"},{"name":"visibility","value":"visible"},{"name":"border-radius","value":"7px"},{"name":"box-sizing","value":"border-box"},{"name":"font-size","value":"16.5px"},{"name":"pointer-events","value":"inherit"},{"name":"vertical-align","value":"middle"},{"name":"div.background-color","value":"transparent"},{"name":"div.border-radius","value":"11px"},{"name":"div.border","value":"1px solid #ddd"},{"name":"div.display","value":"block"},{"name":"div.margin","value":"25px 0px 25px 0px"},{"name":"div.padding","value":"0px 0px 0px 0px"},{"name":"div.pointer-events","value":"inherit"},{"name":"div.position","value":"relative"},{"name":"div.width","value":"auto"}];
			...
			try {
				...
				for (var i = 0; i < evtArr.length; i++) {
					itm = evtArr[i]; 
					$f.setevent('loginprompt', itm[0], itm[1], $nim.fn.findEvent('xchat', 'loginprompt', evtArr[i]));
				}
				...
				$nim.Load32.onComplete(function() {
					...
					$nim.Load32.Clear(true);
					$k.instance.setbyelemid(widgTarget);
					if ($f.getprop('loginprompt','','forceshow').toLowerCase() == 'true') $heap.xchat['loginprompt'].Show(pos);
					return;
				});
				if ($nim.Load32.list[list].length > 0) {
					$nim.Load32.ArrayLoad(list, 0);
...
$k.wrapallfunctions($heap.xchat['loginprompt'].Code, 'loginprompt');
...
var _config = {
	...
	copyright: '(c) 2017',
	compiledon: '04/15/2025 05:52 pm',
	version: '1.0',
	...
	// METHODS
	dialog: {
		'applanding': $k.instance.newobject($heap.xchat['applanding']),
		'loginforgot': $k.instance.newobject($heap.xchat['loginforgot']),
		'loginmain': $k.instance.newobject($heap.xchat['loginmain']),
		'loginmsg': $k.instance.newobject($heap.xchat['loginmsg']),
		'loginprofile': $k.instance.newobject($heap.xchat['loginprofile']),
		'loginregister': $k.instance.newobject($heap.xchat['loginregister']),
		'loginsplash': $k.instance.newobject($heap.xchat['loginsplash']),
		'loginreset': $k.instance.newobject($heap.xchat['loginreset']),
		'loginconfirm': $k.instance.newobject($heap.xchat['loginconfirm']),
		'loginprompt': $k.instance.newobject($heap.xchat['loginprompt']),
	},
	onStartup: function(pos) {
		$heap.xchat[pos.form].Load(pos);
	},
	onLoadLibs: function() {
// --------------------------------------
